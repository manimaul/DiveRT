###############################################################################
# pyGEtools - Draft/examples/bits and bobs (public domain)
...
def ge_openKmlFile():
    ...
    GE.OpenKmlFile("C:\ProgramData\DiveRT\DiveRT.kml",False)
   
if __name__=="__main__":
    ge_connect()   
   
    #ge_cam_diff_azimuth(-10)
    #ge_cam_diff_tilt(-10)
    #ge_cam_diff_range(-100000)
